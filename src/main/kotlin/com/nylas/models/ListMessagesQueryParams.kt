 ...
 */
data class ListMessagesQueryParams(
  /**
   ...
   */
  @Json(name = "received_before")
  val receivedBefore: Int? = null,
  /**
   * Return emails that have been received after this timestamp.
   */
  @Json(name = "received_after")
  val receivedAfter: Int? = null,
  /**
  ...
  class Builder {
    ...
    private var receivedBefore: Int? = null
    private var receivedAfter: Int? = null
     ...
     * @return The builder
     */
    fun receivedBefore(receivedBefore: Int?) = apply { this.receivedBefore = receivedBefore }
     ...
     * @return The builder
     */
    fun receivedAfter(receivedAfter: Int?) = apply { this.receivedAfter = receivedAfter }
     ...
     */
    fun build() = ListMessagesQueryParams(
      limit = limit,
      pageToken = pageToken,
      subject = subject,
      anyEmail = anyEmail,
